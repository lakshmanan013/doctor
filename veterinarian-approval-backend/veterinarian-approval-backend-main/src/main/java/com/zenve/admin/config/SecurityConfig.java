...
import com.zenve.admin.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtService jwtService, AdminRepository adminRepository, CorsProperties corsProperties) {
